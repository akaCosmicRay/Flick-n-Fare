...
function fareSearch() {
  ...
  var settings1 = {
    url:
      ...
      "/information?cuisine=" +
      fare +
      "&offset=50&number=1&instructionsRequired=true&includeNutrition=true&apiKey=8cbaee7bf79a4c9197896e412732b8c8",
    method: "GET",
    timeout: 0,
    headers: {},
  };
...
function getRandomFare() {
  ...
  var settings2 = {
    url:
      ...
      fare +
      "&offset=50&number=1&instructionsRequired=true&apiKey=8cbaee7bf79a4c9197896e412732b8c8",
    method: "GET",
    timeout: 0,
    headers: {},
  };
...
function createRecipeHistory(id, text) {
  ...
  recipeHistory.html(text.slice(1,-1) + " ");
  var delRecipe = $("<button>");
  delRecipe.attr("data-recipe-id", id);
  delRecipe.addClass("btn btn-sm checkbox");
  delRecipe.html("x");
...
function createMovieHistory(id, text) {
  ...
  movieHistory.html(text.slice(1,-1) + " ");
  var delMovie = $("<button>");
  delMovie.attr("data-movie-id", id);
  delMovie.addClass("btn btn-sm checkbox");
  delMovie.html("x");
